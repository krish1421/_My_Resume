...
from newapp.views import RegisterUserView,UserDetailView,ChangePasswordView
...
urlpatterns = [
    ...
    path('api/updateuser/',UserDetailView.as_view(),name ='token_obtain_pair'),
    path('api/changepassword/',ChangePasswordView.as_view(),name ='token_obtain_pair'),
